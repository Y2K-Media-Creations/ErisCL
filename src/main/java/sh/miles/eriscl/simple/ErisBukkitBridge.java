...
/**
 * This class bridges the gap between ErisCL simple packages and Bukkit command
 * classes.
 * <p>
 * This class is not meant to be used by the end user. It is only used
 * internally by ErisCL to bridge the gap between the simple packages and the
 * Bukkit command classes.
 */
public final class ErisBukkitBridge extends BukkitCommand {
    ...
    private final ErisCommand command;

    public ErisBukkitBridge(ErisCommand command) {
